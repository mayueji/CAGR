...
class WindingNumberTreecode:
    def __init__(self,
        ...
        self.points = points
        self.points2 = torch.ones(points.shape[0]*3, device=self.device)
    ...
    def forward_A21(self, normals, widths):
        ...
        node_normals, node_reppoints, _ = \
            self.treecode_package.scatter_point_attrs_to_nodes(self.node_parent_list,
                                                    ...
                                                    self.node_is_leaf_list,
                                                    self.tree_depth)
        out_vals = self.treecode_package.multiply_by_A21(
            self.points,
            widths,
            self.points,
            normals,
    ...
    def forward_A22(self, normals, widths):
        ...
        node_normals, node_reppoints, _ = \
            self.treecode_package.scatter_point_attrs_to_nodes(self.node_parent_list,
                                                    ...
                                                    self.node_is_leaf_list,
                                                    self.tree_depth)
        out_vals = self.treecode_package.multiply_by_A22(
            self.points,
            widths,
            self.points,
            normals,
    ...
    def forward_A23(self, normals, widths):
        ...
        node_normals, node_reppoints, _ = \
            self.treecode_package.scatter_point_attrs_to_nodes(self.node_parent_list,
                                                    ...
                                                    self.node_is_leaf_list,
                                                    self.tree_depth)
        out_vals = self.treecode_package.multiply_by_A23(
            self.points,
            widths,
            self.points,
            normals,
    ...
    def forward_A2T1(self, values, widths):
        """
        values: [N, 1]
        widths: [N,]
        """
        ...
        out_vecs = self.treecode_package.multiply_by_A2T1(
            self.points,
            widths,
            self.points,
            values,
    ...
    def forward_A2T2(self, values, widths):
        """
        values: [N, 1]
        widths: [N,]
        """
        ...
        out_vecs = self.treecode_package.multiply_by_A2T2(
            self.points,
            widths,
            self.points,
            values,
    ...
    def forward_A2T3(self, values, widths):
        """
        values: [N, 1]
        widths: [N,]
        """
        ...
        out_vecs = self.treecode_package.multiply_by_A2T3(
            self.points,
            widths,
            self.points,
            values,
